package com.hongyi.hr.module.system.service.tenant;
...
import com.hongyi.hr.framework.tenant.config.TenantProperties;
import com.hongyi.hr.framework.tenant.core.context.TenantContextHolder;
import com.hongyi.hr.framework.tenant.core.util.TenantUtils;
import com.hongyi.hr.module.system.controller.admin.permission.vo.role.RoleSaveReqVO;
import com.hongyi.hr.module.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
import com.hongyi.hr.module.system.controller.admin.tenant.vo.tenant.TenantSaveReqVO;
import com.hongyi.hr.module.system.convert.tenant.TenantConvert;
import com.hongyi.hr.module.system.dal.dataobject.permission.MenuDO;
...
import com.hongyi.hr.module.system.dal.dataobject.tenant.TenantPackageDO;
import com.hongyi.hr.module.system.dal.mysql.tenant.TenantMapper;
import com.hongyi.hr.module.system.enums.permission.RoleCodeEnum;
import com.hongyi.hr.module.system.enums.permission.RoleTypeEnum;
import com.hongyi.hr.module.system.service.permission.MenuService;
...
import com.hongyi.hr.module.system.service.tenant.handler.TenantInfoHandler;
import com.hongyi.hr.module.system.service.tenant.handler.TenantMenuHandler;
...
public class TenantServiceImpl implements TenantService {
    ...
    @Autowired(required = false) // 由于 hongyi.tenant.enable 配置项，可以关闭多租户的功能，所以这里只能不强制注入
