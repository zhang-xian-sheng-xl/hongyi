package com.hongyi.hr.module.system.controller.admin.socail.vo.client;
...
import com.hongyi.hr.framework.common.validation.InEnum;
...
public class SocialClientSaveReqVO {
    ...
    @Schema(description = "应用名", requiredMode = Schema.RequiredMode.REQUIRED, example = "hongyi商城")
