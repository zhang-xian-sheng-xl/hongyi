package com.hongyi.hr.module.system.service.social;
...
import com.hongyi.hr.framework.common.enums.CommonStatusEnum;
import com.hongyi.hr.framework.common.enums.UserTypeEnum;
import com.hongyi.hr.framework.common.pojo.PageResult;
import com.hongyi.hr.framework.common.util.cache.CacheUtils;
import com.hongyi.hr.framework.common.util.http.HttpUtils;
import com.hongyi.hr.framework.common.util.object.BeanUtils;
import com.hongyi.hr.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.hongyi.hr.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import com.hongyi.hr.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import com.hongyi.hr.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import com.hongyi.hr.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import com.hongyi.hr.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import com.hongyi.hr.module.system.dal.dataobject.social.SocialClientDO;
import com.hongyi.hr.module.system.dal.mysql.social.SocialClientMapper;
import com.hongyi.hr.module.system.dal.redis.RedisKeyConstants;
import com.hongyi.hr.module.system.enums.social.SocialTypeEnum;
import com.hongyi.hr.module.system.framework.justauth.core.AuthRequestFactory;
...
import static com.hongyi.hr.framework.common.util.collection.MapUtils.findAndThen;
import static com.hongyi.hr.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static com.hongyi.hr.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
import static com.hongyi.hr.framework.common.util.json.JsonUtils.toJsonString;
import static com.hongyi.hr.module.system.enums.ErrorCodeConstants.*;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${hongyi.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${hongyi.wxa-subscribe-message.miniprogram-state:formal}")
    ...
    public void uploadWxaOrderShippingInfo(Integer userType, SocialWxaOrderUploadShippingInfoReqDTO reqDTO) {
        ...
        // 对应 ISSUE：https://gitee.com/zhijiantianya/hongyi-cloud/pulls/230
