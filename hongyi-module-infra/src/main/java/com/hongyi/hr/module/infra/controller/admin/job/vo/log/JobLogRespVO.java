package com.hongyi.hr.module.infra.controller.admin.job.vo.log;
...
import com.hongyi.hr.module.infra.enums.DictTypeConstants;
...
public class JobLogRespVO {
    ...
    @Schema(description = "处理器的参数", example = "hongyi")
