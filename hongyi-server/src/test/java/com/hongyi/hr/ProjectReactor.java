...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.hongyi.hy";
    private static final String ARTIFACT_ID = "hongyi";
    private static final String PACKAGE_NAME = "com.hongyi.hr";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.hongyi.hy";
        String artifactIdNew = "hongyi";
        String packageNameNew = "com.hongyi.hr";
        String titleNew = "土豆管理系统";
        String projectBaseDirNew =  "D:\\ehs\\hongyi\\hongyi"; // 一键改名后，“新”项目所在的目录
