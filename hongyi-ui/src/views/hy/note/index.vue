  ...
  <ContentWrap>
    ...
    >
      ...
      <el-form-item label="系统" prop="item">
        <el-select v-model="queryParams.item" placeholder="请选择系统" clearable class="!w-240px">
          <el-option
      ...
      <el-form-item>
        ...
        <el-button type="primary" plain @click="openForm('create')" v-hasPermi="['hy:note:create']">
