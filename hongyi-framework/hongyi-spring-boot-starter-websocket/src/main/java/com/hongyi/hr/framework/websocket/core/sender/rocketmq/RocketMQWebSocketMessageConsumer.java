package com.hongyi.hr.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${hongyi.websocket.sender-rocketmq.topic}",
        consumerGroup = "${hongyi.websocket.sender-rocketmq.consumer-group}",
