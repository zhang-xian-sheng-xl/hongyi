package com.hongyi.hr.framework.ratelimiter.config;

import com.hongyi.hr.framework.ratelimiter.core.aop.RateLimiterAspect;
import com.hongyi.hr.framework.ratelimiter.core.keyresolver.RateLimiterKeyResolver;
import com.hongyi.hr.framework.ratelimiter.core.keyresolver.impl.*;
...
public class HongyiRateLimiterConfiguration {
