package com.hongyi.hr.framework.tracer.config;

import com.hongyi.hr.framework.common.enums.WebFilterOrderEnum;
import com.hongyi.hr.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "hongyi.tracer", value = "enable", matchIfMissing = true)
public class HongyiTracerAutoConfiguration {
