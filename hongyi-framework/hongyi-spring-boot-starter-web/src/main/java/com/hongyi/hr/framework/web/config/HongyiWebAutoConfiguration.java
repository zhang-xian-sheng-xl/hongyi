package com.hongyi.hr.framework.web.config;
...
import com.hongyi.hr.framework.web.core.filter.CacheRequestBodyFilter;
import com.hongyi.hr.framework.web.core.filter.DemoFilter;
import com.hongyi.hr.framework.web.core.handler.GlobalExceptionHandler;
import com.hongyi.hr.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class HongyiWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "hongyi.demo", havingValue = "true")
