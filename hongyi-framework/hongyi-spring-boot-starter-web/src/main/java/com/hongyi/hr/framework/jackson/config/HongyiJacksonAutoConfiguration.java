package com.hongyi.hr.framework.jackson.config;

import com.hongyi.hr.framework.common.util.json.JsonUtils;
import com.hongyi.hr.framework.common.util.json.databind.NumberSerializer;
import com.hongyi.hr.framework.common.util.json.databind.TimestampLocalDateTimeDeserializer;
import com.hongyi.hr.framework.common.util.json.databind.TimestampLocalDateTimeSerializer;
...
@Slf4j
public class HongyiJacksonAutoConfiguration {
